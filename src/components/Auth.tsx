    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-100 to-slate-200">
      <Card className="w-full max-w-md shadow-xl border-none">
        <CardHeader className="space-y-1 flex flex-col items-center">
          ...
          <CardTitle className="text-2xl font-bold tracking-tight">GabaritoFácil</CardTitle>
          <CardDescription>
            {isLogin ? 'Entre na sua conta de professor' : 'Crie sua conta de professor'}
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter>
          <Button variant="link" className="w-full text-sm" onClick={() => setIsLogin(!isLogin)}>
